module github.com/jewzaam/blogs
...
require (
	...
	github.com/openshift/console-operator v0.0.0-20190731214154-01743ef608d4
	github.com/openshift/library-go v0.0.0-20190801153120-1810ce5f54ff
